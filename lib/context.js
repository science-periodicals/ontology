...
var context = require('schema.org/context');
...
let schemaMap = {
  ...
  knowsAbout: { '@container': '@set', '@type': '@id' },
  mainEntity: { '@type': '@id' },
